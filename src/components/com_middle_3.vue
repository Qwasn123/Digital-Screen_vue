<template>
    <div class="grid grid_middle_1">
        ...
        <table style="position: relative;bottom: 10px;">
            <tr>
                <td class="table_type middle_type">{{ this.tableData.pv3A.title }}</td>
                <td class="table_type middle_data" style="position: relative;right: 30px;">{{ this.tableData.pv3A.value }}&nbsp<span class="unit-style"> {{ this.tableData.pv3A.unit
                }} </span> </td>
                <td class="table_type middle_type">{{ this.tableData.pv3V.title }}</td>
                <td class="table_type middle_data" style="position: relative;right: 30px;">{{ this.tableData.pv3V.value }}&nbsp<span class="unit-style">{{ this.tableData.pv3V.unit
                }}</span> </td>
                ...
                series: [
                    {
                        ...
                        type: 'line',
                        smooth: true,
                        data: [12.95, 1.36, 14.93, 2.40, 16.50, 10.25, 7.20, 14.57, 17.99, 3.09, 5.57, 10.59],
                        yAxisIndex: 0,
                        symbol: 'none'
                    },
                    {
                        ...
                        type: 'line',
                        smooth: true,
                        data: [223.33, 214.48, 237.89, 207.24, 230.40, 201.97, 222.10, 203.49, 242.50, 240.94, 213.32, 231.82],
                        yAxisIndex: 1,
                        symbol: 'none'
                    }
                ]
